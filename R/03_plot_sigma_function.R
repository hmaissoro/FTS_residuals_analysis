...
dt_sig_sinus <- data.table("t" = seq(0, 1, len = 100), "sig" = sigma_sin(seq(0, 1, len = 100)))
...
dt_sig_linear <- data.table("t" = seq(0, 1, len = 100), "sig" = sigma_linear(seq(0, 1, len = 100)))
...
dt_sig_logistic <- data.table("t" = seq(0, 1, len = 100), "sig" = sigma_logistic(seq(0, 1, len = 100), slope = 15))
